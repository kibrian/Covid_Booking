...
<div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Booked successfully!!</h2>
                    <div class="alert alert-danger"> you've a scheduled appointment. Please <a href="dashboard-1.php" class="alert-link">proceed</a></div>
                </div>
            </div>        
        </div>
    </div>
